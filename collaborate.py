...
# Alternates between asking the human for input and asking the model to generate, producing a collaborative composition
...
def collaborate_document(writer, maxlines=14):
    """Creates a single document by collaboration between human and pre-trained model
    ...
    print("\n\n")
    print("Human, we created this composition together. Thanks for your inspiration!\n")
    print(composition)
    return composition

if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Human-machine collaborative text generation, following the style of'
    ...
    collaborate(modelname=args.model, encodername=args.encoder, creativity=args.creativity)
